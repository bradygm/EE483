classdef beamController
    ...
    methods
        ...
        function self = beamController(P)
            ...
            self.zCtrl = beamPIDControl(P.z0, P.kp_z, P.ki_z, P.kd_z, P.theta_max, P.beta, P.Ts);
            self.thetaCtrl = beamPIDControl(P.theta0,P.kp_th, 0.0, P.kd_th, P.F_max, P.beta, P.Ts);
            self.m2 = P.m2;
            self.g = P.g;
            self.ell = P.ell;
            self.m1 = P.m1;
        ...
        function F = u(self, y_r, y)
            ...
            F_tilda = self.thetaCtrl.PID(theta_r, theta, false);
