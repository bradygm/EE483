classdef beamController1 < handle
    % 
    ...
    methods
        %----------------------------
        function self = beamController1(P)
...
%             self.xout_F(1) = .25;
        ...
        function F = u(self, y_r, y)
            ...
            F_unsat = self.Cin_C*self.xin_C + self.Din_C*error_in + (self.m2*self.g*self.ell+2*self.m1*self.g*(self.ell/2))/(2*self.ell);
